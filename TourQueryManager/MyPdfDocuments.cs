...
namespace TourQueryManager
{
    ...
    class MyPdfDocuments
    {
        ...
        private static string itenaryAvailablityNote = " Subject to weather conditions and availability of Ferry Tickets and other Conditions, the itinerary may be shuffled." +
        ...
        private static string itenaryNotIncludedNote = " Cost for supplementary service, optional Tours, Up-gradation Charges, Guide, Additional Sightseeing entrance fees." +
        ...
        private static string itenaryImportantFacts = " Please carry original ID proof (Voter ID card/Pass-port/Driving License/etc.) for security purpose & hotel policy." +
        ...
        private static string itenaryPaymentPolicy = " Any confirmation is subject to an advance deposit of 50% of the package cost and has to be paid immediately," +
